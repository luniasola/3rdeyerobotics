        ...
        <Header className={'h-screen w-full landscapes@xs:h-[600px] landscapes@md:h-[600px]'}>
            ...
            <Div className={'relative z-20 mx-auto flex h-screen max-w-screen-2xl items-center justify-between p-4 align-middle md:p-6 2xl:p-0'}>
                <Div className={'flex flex-col gap-4 md:gap-8'}>
                    <motion.div animate={{ opacity : 1,  y : 0 }} className={'mt-[29.000rem] flex flex-col gap-2 md:mt-0 xs:mt-64 landscapes@md:mt-52'} initial={{ opacity : 0, y : 20 }} transition={{ type : 'spring', stiffness : 50, damping : 30, duration : 0.5, delay : 0.5 }}>
                    ...
                    <motion.div animate={{ opacity : 1, y : 0 }} className={'absolute bottom-10 mt-auto flex md:bottom-20 landscapes@md:relative landscapes@md:top-16'} initial={{ opacity : 0, y : -20 }} transition={{ type : 'spring', stiffness : 50, damping : 30, duration : 0.5, delay : 0.5 }}>
