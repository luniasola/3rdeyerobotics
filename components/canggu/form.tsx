...
import { Span }       from '@/components/canggu/block'
...
export const Fieldset = React.forwardRef<HTMLFieldSetElement, React.HTMLProps<HTMLFieldSetElement>>(({ className, ...props }, ref) => <fieldset className={classNames('mb-3.5 flex flex-col gap-0.5 last:mb-0', className)} ref={ref} {...props} />)
...
export const Input = React.forwardRef<HTMLInputElement, React.InputHTMLAttributes<HTMLInputElement>>(({ className, type, ...props }, ref) => (
    <input className={classNames('focus-visible:ring-primary/50 flex h-12 w-full rounded-md border border-component-input bg-foundation px-3 py-1 text-sm shadow-sm shadow-black/10 transition-colors file:mr-1.5 file:mt-1.5 file:cursor-pointer file:border-0 file:bg-transparent file:p-0 file:text-sm file:font-medium file:text-foundation-foreground placeholder:text-muted focus-visible:outline-none focus-visible:ring disabled:cursor-not-allowed disabled:opacity-50 dark:bg-foundation-secondary dark:text-white dark:placeholder:text-muted/75', className)} ref={ref} type={type} {...props} />
))
